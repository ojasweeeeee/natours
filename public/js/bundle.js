...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2phc3dpc2F4ZW5hIiwiYSI6ImNsYWo2MDk5eDA5aDMzcnF0MzBtcHk2YWUifQ._LKbHa2GgiAVgisGuSZz7g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ojaswisaxena/claj6w3q3002l15uhs9feufln/draft',
    scrollZoom: false
  });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51MAosUSGw1Fc2Vlc73rxiLA9Pvvclq4IZlvEixijrKq1q5PQgKLk5YEjgrvOCTUo89E42lfqKOQra2oHZxA7FJVa00zsiVkkax');
            _context.prev = 1;
            _context.next = 4;
